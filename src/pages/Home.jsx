...
function Home() {
  ...
  return (
    <>
      <div style={{ width: '100%', height: '100vh', backgroundColor: "blue" }}>
        <div className="row container" style={{ height: '80vh' }}>
          ...
          <div className="col-md-2 d-flex justify-content-center align-items-center" style={{ marginTop: '20px' }} >
            <img width='650' src='https://assets.website-files.com/6174a877844b8d384f2230b9/621405faf156b68381c89877_Untitled%20design.gif' />
          </div>
          <div className="col-md-1"></div>
        </div>
      ...
      <div className="all-project" style={{ backgroundColor: "blue" }}>
        <div className="text-center">
          <h1 style={{ color: 'white', fontWeight: 'bold', fontSize: '35px' }}>Explore Our Projects</h1>
          <div className="text-center text-light " style={{ backgroundColor: "black" }}>
